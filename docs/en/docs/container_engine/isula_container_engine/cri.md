...
The lifecycle of a container is isolated from that of an image. Therefore, two services are required. CRI API is defined using [Protocol Buffers](https://protobuf.dev/) and is based on [gRPC](https://grpc.io/).
